        ...
        <div className="space-y-3 text-sm">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#0f1117] rounded-lg p-3">
              ...
              <p className="text-white font-medium">
                {request.user?.nickname ?? request.userId}
              </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#0f1117] rounded-lg p-3">
              ...
              <p className="text-red-400 font-mono font-bold">
                {request.amountChips.toLocaleString()}
              </p>
            </div>
            <div className="bg-[#0f1117] rounded-lg p-3">
          ...
          <div className="bg-[#0f1117] rounded-lg p-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                href={`https://sepolia.etherscan.io/address/${request.toAddress}`}
                target="_blank"
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="flex gap-3 mb-6">
          ...
          >
            ...
            {(["PENDING", "PROCESSING", "CONFIRMED", "FAILED"] as const).map(
              (s) => (
        ...
        <div className="md:hidden space-y-3 mb-4">
          {loading ? (
            ...
            data?.data?.map((req) => (
              <div
                key={req.id}
                className="bg-[#161b27] border border-[#1e2535] rounded-xl p-4 space-y-2"
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-slate-500 text-xs">
                      @{req.user?.username ?? req.userId.slice(0, 8)}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div>
                    ...
                    <span className="font-mono text-red-400">
                      -{req.amountChips.toLocaleString()}
                    </span>
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-1">
                  <span className="text-blue-400 font-mono text-xs">
                    {shortAddress(req.toAddress)}
                  </span>
                  <a
                    href={`https://sepolia.etherscan.io/address/${req.toAddress}`}
                    target="_blank"
                    rel="noopener noreferrer"
