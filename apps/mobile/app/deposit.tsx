...
const BLOCK_EXPLORER = process.env.EXPO_PUBLIC_BLOCK_EXPLORER_URL ?? 'https://sepolia.etherscan.io';
...
export default function DepositScreen() {
  ...
  const [faucetMsg, setFaucetMsg] = useState<{ text: string; txHash?: string } | null>(null);
        ...
        {loading ? (
          ...
          <>
            ...
            <View style={styles.qrCard}>
              ...
              <Text style={styles.networkLabel}>{depositAddr.network} · {depositAddr.token}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#e5e7eb', fontSize: 15, fontWeight: '600', marginBottom: 14 },
  qrWrap: { padding: 12, backgroundColor: '#0d1f14', borderRadius: 10, marginBottom: 10 },
  ...
  addr: { color: '#4ade80', fontSize: 12, fontFamily: 'monospace', marginBottom: 12 },
  addrBtns: { flexDirection: 'row', gap: 10, marginBottom: 10 },
  copyBtn: { flex: 1, backgroundColor: '#16a34a', borderRadius: 8, padding: 10, alignItems: 'center' },
  copyBtnText: { color: '#fff', fontWeight: 'bold' },
  shareBtn: { flex: 1, backgroundColor: '#1d4ed8', borderRadius: 8, padding: 10, alignItems: 'center' },
  ...
  faucetBtn: { backgroundColor: '#7c3aed', borderRadius: 8, padding: 12, alignItems: 'center' },
  btnDisabled: { opacity: 0.6 },
  faucetBtnText: { color: '#fff', fontWeight: 'bold' },
  faucetMsg: { color: '#4ade80', fontSize: 13, marginTop: 10, textAlign: 'center' },
