...
export default function WithdrawScreen() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      api
        .get<CooldownInfo>("/withdraw/cooldown")
        .then((r) => setCooldown(r.data))
        .catch(() => {});
    }, 5000);
    return () => {
      cancelled = true;
        ...
        <ScrollView contentContainerStyle={styles.content}>
            ...
            <View style={styles.balanceCard}>
              ...
              <View style={styles.balanceInfoRow}>
                ...
                <View style={styles.balanceInfoItem}>
                  ...
                  <Text style={[styles.balanceInfoValue, { color: "#4ade80" }]}>
                    1 = {balance.rate}
                  </Text>
                </View>
              </View>
          ...
          <View style={styles.formCard}>
            ...
            <View style={styles.field}>
              ...
              />
              {addressError ? (
                <Text style={styles.errorHint}>{addressError}</Text>
              ) : null}
            </View>
            ...
            >
              {submitting ? (
                ...
                <Text style={styles.submitBtnText}>
                  {t("withdraw.cooldown")}: {remainingSec}s
                </Text>
              ) : (
                <Text style={styles.submitBtnText}>
