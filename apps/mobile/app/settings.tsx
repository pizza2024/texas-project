      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
            ...
            <View style={styles.avatarBtns}>
              ...
              >
                {uploading ? (
                  ...
                  <Text style={styles.avatarBtnText}>{t('settings.uploadAvatar')}</Text>
                )}
              </TouchableOpacity>
              {profile?.avatarUrl && (
                <TouchableOpacity style={styles.removeBtn} onPress={handleRemoveAvatar}>
                  <Text style={styles.removeBtnText}>{t('settings.removeAvatar')}</Text>
                </TouchableOpacity>
              )}
            </View>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>{profile?.coinBalance.toLocaleString()}</Text>
            </View>
            <View style={styles.infoRow}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.langBtns}>
            <TouchableOpacity
              style={[styles.langBtn, i18n.language === 'zh-CN' && styles.langBtnActive]}
              onPress={() => changeLanguage('zh-CN')}
            >
              <Text style={[styles.langBtnText, i18n.language === 'zh-CN' && styles.langBtnTextActive]}>
                中文
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.langBtn, i18n.language === 'en-US' && styles.langBtnActive]}
              onPress={() => changeLanguage('en-US')}
            >
              <Text style={[styles.langBtnText, i18n.language === 'en-US' && styles.langBtnTextActive]}>
                English
              </Text>
            </TouchableOpacity>
          </View>
