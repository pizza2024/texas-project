  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 px-4">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 45%, #0f5a28 0%, #083d19 50%, #041f0d 100%)",
          borderColor: "#78350f",
          boxShadow:
            "0 0 0 2px rgba(234,179,8,0.2), 0 0 80px rgba(0,0,0,0.9), inset 0 0 100px rgba(0,0,0,0.3)",
        }}
      >
              ...
              table.communityCards.map((card, i) => (
                <div key={i} style={getDealAnimationStyle(`community-${i}`)}>
                  <CardDisplay
                    card={card}
                    large
                    highlight={highlightedCommunityCardsSet.has(card)}
                  />
                </div>
              ))
            ) : (
          ...
          >
            <div className="relative flex items-center justify-center">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 30% 30%, #fef3c7 0%, #f59e0b 45%, #92400e 100%)",
                  boxShadow:
                    "0 0 18px rgba(245,158,11,0.35), 0 4px 10px rgba(0,0,0,0.45)",
          ...
          >
            <div className="relative flex items-center justify-center">
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 30% 30%, #fde68a 0%, #f59e0b 42%, #854d0e 100%)",
                  boxShadow:
                    "0 0 22px rgba(251,191,36,0.4), 0 4px 12px rgba(0,0,0,0.5)",
