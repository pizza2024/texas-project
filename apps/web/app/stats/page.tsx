        ...
        {!loading && !error && stats && (
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <p className="text-xs uppercase tracking-widest" style={{ color: 'rgba(245,158,11,0.6)' }}>
                  {t('stats.handsPlayed')}
                </p>
                <p className="text-3xl font-bold" style={{ color: '#f59e0b' }}>{stats.handsPlayed}</p>
                <p className="text-sm" style={{ color: 'rgba(255,255,255,0.5)' }}>
                  {t('stats.handsWon')}：<span style={{ color: '#facc15' }}>{stats.handsWon}</span>
                </p>
              </div>
              ...
              >
                ...
                <ProfitText value={stats.totalProfit} className="text-3xl font-bold" />
              </div>
              ...
              >
                ...
                <div className="text-sm space-y-1">
                  <div className="flex justify-between">
                    <span style={{ color: 'rgba(255,255,255,0.5)' }}>{t('stats.biggestWin')}</span>
                    <ProfitText value={stats.biggestWin} />
                  </div>
                  <div className="flex justify-between">
                    <span style={{ color: 'rgba(255,255,255,0.5)' }}>{t('stats.biggestLoss')}</span>
            ...
            >
              ...
              >
                <h2 className="text-sm font-semibold tracking-wide uppercase" style={{ color: '#f59e0b' }}>
                  {t('stats.recentHands')}
                </h2>
              </div>
