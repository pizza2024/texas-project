...
export default function SettingsPage() {
  ...
  const { soundSettings, toggleSoundSetting, handleVolumeChange } =
    useSoundSettings();
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none select-none overflow-hidden">
        <span className="absolute top-8 left-8 text-[9rem] font-serif opacity-[0.03] text-yellow-400 -rotate-12">
          ♠
        </span>
        <span className="absolute bottom-10 right-8 text-[9rem] font-serif opacity-[0.03] text-yellow-400 rotate-6">
          ♣
        </span>
      </div>
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              >
                ...
                <div
                  className="mt-2 text-sm font-semibold break-all"
            ...
            >
              ...
              <form onSubmit={handlePasswordChange} className="space-y-3">
                <input
                  ...
                  className="w-full rounded-xl px-4 py-3 text-sm bg-white/[0.06] border border-white/[0.1] text-white placeholder:text-white/30 focus:outline-none focus:border-yellow-500/50"
                ...
                <button
                  ...
                  className="w-full h-11 rounded-xl text-sm font-black tracking-[0.12em] uppercase transition-all disabled:opacity-50"
                  style={{
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span
                    ...
                    style={{
                      color:
                        safeVolume > 0 ? "#f59e0b" : "rgba(156,163,175,0.75)",
                    }}
                  >
              ...
              <div className="grid gap-3">
                {(
                  [
                    [
                      "deal",
                      t("settings.soundDeal"),
                      t("settings.soundDealDesc"),
                    ],
                    [
                      "countdown",
                      t("settings.soundCountdown"),
                      t("settings.soundCountdownDesc"),
                    ],
                    [
                      "winner",
                      t("settings.soundWinner"),
                      t("settings.soundWinnerDesc"),
                    ],
                  ] as const
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div>
                          <div
                            ...
                            style={{ color: enabled ? "#86efac" : "#e5e7eb" }}
                          >
                            {enabled ? "🔊" : "🔇"} {label}
                          </div>
                          <div
