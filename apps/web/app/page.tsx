...
export default function Home() {
  ...
  useEffect(() => {
    api
      ...
      .catch(() => {
        /* silent — badge stays as fallback */
      });
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
        <span className="absolute top-8  left-8   text-[14rem] font-serif opacity-[0.035] text-yellow-400 -rotate-12">
          ♠
        </span>
        <span className="absolute top-12 right-10  text-[16rem] font-serif opacity-[0.03]  text-yellow-400 rotate-6">
          ♥
        </span>
        <span className="absolute bottom-16 left-14 text-[13rem] font-serif opacity-[0.03]  text-yellow-400 rotate-3">
          ♦
        </span>
        <span className="absolute bottom-8  right-8  text-[14rem] font-serif opacity-[0.035] text-yellow-400 -rotate-6">
          ♣
        </span>
        {/* center glow */}
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(234,179,8,0.05) 0%, transparent 65%)",
          }}
        />
      </div>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{
              background:
                "linear-gradient(135deg, #d97706 0%, #fcd34d 50%, #d97706 100%)",
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 pt-16 pb-10">
        ...
        <h1
          ...
          style={{
            background:
              "linear-gradient(160deg, #fbbf24 0%, #fcd34d 35%, #f59e0b 60%, #d97706 100%)",
            WebkitBackgroundClip: "text",
            WebkitTextFillColor: "transparent",
            backgroundClip: "text",
            textShadow: "none",
        ...
        <p className="text-xl sm:text-2xl font-light text-gray-300 mb-3 max-w-lg leading-snug">
          Texas Hold&apos;em,{" "}
          <span style={{ color: "rgba(245,158,11,0.9)" }}>on-chain spirit</span>
        </p>
        <p className="text-sm text-gray-500 max-w-sm mb-12 leading-relaxed">
          Bluff big. Call smart. The pot belongs to the boldest player at the
          table.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-16">
          <Link
            ...
            style={{
              background:
                "linear-gradient(135deg, #92400e 0%, #b45309 25%, #d97706 60%, #f59e0b 100%)",
              color: "#000",
              boxShadow:
                "0 0 40px rgba(245,158,11,0.3), 0 8px 24px rgba(0,0,0,0.5)",
            }}
          >
            🃏 &nbsp;Deal Me In
          </Link>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(160deg, rgba(10,20,14,0.95) 0%, rgba(5,12,8,0.98) 100%)",
            border: "1px solid rgba(234,179,8,0.2)",
            boxShadow:
              "0 0 60px rgba(0,0,0,0.8), inset 0 0 40px rgba(234,179,8,0.03)",
          }}
        >
          {/* Preview header */}
          <div
          ...
          <div className="relative px-8 py-10">
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse at 50% 40%, #1a3d2a 0%, #0f2318 60%, #0a1810 100%)",
                border: "3px solid rgba(234,179,8,0.35)",
                boxShadow:
                  "inset 0 0 60px rgba(0,0,0,0.6), 0 0 20px rgba(234,179,8,0.1)",
              }}
            >
              {/* Community cards row */}
              <div className="flex justify-center gap-3 mb-8">
                ...
                >
                  ...
                  <span className="text-black font-black">J</span>
                </div>
                {/* Card 3 (flop) */}
                <div
                  className="w-14 h-20 rounded-lg flex items-center justify-center font-serif text-2xl font-black"
                ...
                >
                  <span className="text-black">♣</span>
                  <span className="text-black font-black">9</span>
                </div>
                {/* Card 4 */}
                <div
                  className="w-14 h-20 rounded-lg flex items-center justify-center font-serif text-2xl font-black"
                ...
                >
                  <span className="text-black">♦</span>
                  <span className="text-black font-black">7</span>
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #1e3a5f 0%, #152a45 100%)",
                    boxShadow: "2px 3px 8px rgba(0,0,0,0.5)",
              ...
              <div className="text-center mb-6">
                <span className="text-xs tracking-[0.25em] uppercase text-gray-500 mb-1 block">
                  Pot
                </span>
                <span
              ...
              <div className="flex justify-between items-end px-2">
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <div className="text-center">
                    <div className="text-xs font-bold text-yellow-400/80">
                      You
                    </div>
        ...
        <div className="flex items-center gap-4 w-full max-w-2xl mb-12">
          ...
          />
          <span className="text-yellow-700/40 text-xs tracking-[0.3em] uppercase">
            Why CHIPS?
          </span>
          <div
            className="flex-1 h-px"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 w-full max-w-3xl">
          {FEATURES.map((f) => (
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, rgba(12,22,16,0.9) 0%, rgba(6,12,9,0.95) 100%)",
                border: "1px solid rgba(234,179,8,0.15)",
                boxShadow:
                  "0 0 0 1px rgba(234,179,8,0.05), 0 8px 32px rgba(0,0,0,0.4)",
              }}
            >
