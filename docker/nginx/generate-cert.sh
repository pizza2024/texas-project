#!/bin/bash
# Generate self-signed certificate for the configured domain

set -e

CERT_DIR="docker/nginx/certs"
DOMAIN="${1:-${DOMAIN:-not-replaced-yet.com}}"
DAYS=365
...
echo ""
echo "Self-signed certificate warning:"
...
echo "      - web.$DOMAIN -> Lightsail IP"
echo "      - admin.$DOMAIN -> Lightsail IP"
echo "      - api.$DOMAIN -> Lightsail IP"
echo ""
